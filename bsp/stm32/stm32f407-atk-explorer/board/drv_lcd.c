...
//注意设置时STM32内部会右移一位对其!
#define LCD_ILI9341_BASE        ((rt_uint32_t)(0x6C000000 | 0x0000007E))
...
__weak void HAL_SRAM_MspInit(SRAM_HandleTypeDef *hsram)
{
	...
	//init PD0,1,4,5,8,9,10,13,14,15
...
void _lcd_low_level_init(void)
{
	...
	SRAM_Handler.Init.WrapMode=FSMC_WRAP_MODE_DISABLE;//ADD
