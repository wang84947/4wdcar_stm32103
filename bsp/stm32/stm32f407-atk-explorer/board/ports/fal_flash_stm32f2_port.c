...
const struct fal_flash_dev stm32_onchip_flash_16k  = { "stm32_onchip", 0x08000000, 4*16*1024, 16*1024, {init, read, write, erase} };
const struct fal_flash_dev stm32_onchip_flash_64k  = { "stm32_onchip", 0x08010000, 64*1024,   64*1024, {init, read, write, erase} };
const struct fal_flash_dev stm32_onchip_flash_128k = { "stm32_onchip", 0x08020000, 7*128*1024,128*1024, {init, read, write, erase} };
